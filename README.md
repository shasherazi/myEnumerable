...
**[myEnumerable]** is project to create our own Enumerable using Ruby.
...
- **[A_subset_of_the_functionality_of_Enumerable.]**
...
2. clone with this command `git clone https://github.com/shasherazi/myEnumerable.git`
3. cd myEnumerable
...
Feel free to check the [issues page](https://github.com/shasherazi/myEnumerable/issues).
